                ...
                serviceProvider.GetRequiredService<DbContextOptions<MedicalOfficeContext>>()))
            {
                ...
                if (!context.Doctors.Any())
                {
                    context.Doctors.AddRange(
                     new Doctor
                     {
                         ...
                         MiddleName = "A",
                         LastName = "House",
                         DoctorPhysicalDescription = new DoctorPhysicalDescription
                         {
                              Height=1d,
                              Weight=20d,
                              HairColour="Brown",
                              IdentifyingMarks="Scar on lip."
                         }
                     },
                ...
                if (!context.Patients.Any())
                {
                    ...
                    new Patient
                    {
                        ...
                        imageContent= imageToBytes("wwwroot/pictures/Fred.png"),
                        imageMimeType="image/png",
                        imageFileName= "Fred.png",
                    ...
                    new Patient
                    {
                        ...
                        imageContent = imageToBytes("wwwroot/pictures/Wilma.png"),
                        imageMimeType = "image/png",
                        imageFileName = "Wilma.png",
                        DoctorID = context.Doctors.FirstOrDefault(d => d.FirstName == "Gregory" && d.LastName == "House").ID
                    },
                    new Patient
                    {
                        ...
                        imageContent = imageToBytes("wwwroot/pictures/Barney.png"),
                        imageMimeType = "image/png",
                        imageFileName = "Barney.png",
                    ...
                    new Patient
                    {
                        ...
                        imageContent = imageToBytes("wwwroot/pictures/Pebbles.png"),
                        imageMimeType = "image/png",
                        imageFileName = "Pebbles.png",
                ...
                //Seed Appt Reasons
                string[] ApptReasons = new string[] { "Illness", "Accident", "Mental State", "Annual Checkup" };
                ...
                if (!context.Appointments.Any())
                {
                    ...
                    foreach (int i in patientIDs)
                    {
                        ...
                        howMany = (howMany > reasonCount) ? reasonCount : howMany;
                        for (int j = 1; j <= howMany; j++)
                        {
