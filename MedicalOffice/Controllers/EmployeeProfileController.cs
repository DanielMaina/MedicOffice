...
namespace MedicalOffice.Controllers
{
    ...
    public class EmployeeProfileController : Controller
    {
        ...
        //Authenticated user to maintain their own profile.

        private readonly MedicalOfficeContext _context;

        public EmployeeProfileController(MedicalOfficeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,FirstName,LastName,Phone,eMail,Active,FavouriteIceCream")] Employee employee)
        {
